...
public abstract class AlertaVerde2 extends AsyncTask<Void, Void, Void> {
    ...
    public AlertaVerde2(@NonNull String fechaHora, String nombreDateTabla, String nombreTabla, int cantidadDatos, Context context) {
