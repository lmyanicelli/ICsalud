...
public class MyReceiverCONSEJO_SALUDABLE extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent)
    {
        ...
        try{
            ...
            ConsultarCrearNotificacionRecordatorio mConsult = new ConsultarCrearNotificacionRecordatorio(context, Constants.CONSEJO_SALUDABLE);
            mConsult.execute();
