 ...
 *
 * Crea un nuevo registro peso
 */

public class Post_Weight extends AsyncTask<Integer, ArrayList, Boolean> {
 ...
 private static String _PATIENT_ID;
    ...
    private final String KG, DATE_TIME;


    public Post_Weight(Context context, String kg, String date_time) throws ExecutionException, InterruptedException {
        this.context = context;
        this.configuraciones = new Configuraciones(context);
        this._PATIENT_ID = configuraciones.getID();
        //   {{url}}/patients/{{patient}}/weights
        this.BASE_URL = JSON_CONSTANTS.BASE_URL +
                "/" + JSON_CONSTANTS.PATIENTS +
                "/" + _PATIENT_ID +
                "/" + JSON_CONSTANTS.WEIGHTS;
    ...
    protected Boolean doInBackground(Integer... params) {
        ...
        try {
            ...
            jsonObject.put(JSON_CONSTANTS.WEIGHTS_KG, KG);
