...
public class Del_Contact extends AsyncTask<Integer, Void, HashMap<String, String>>{
    ...
    public Del_Contact(Context context, String id_contact) throws ExecutionException, InterruptedException {
