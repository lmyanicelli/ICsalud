 ...
 *
 * Crea un nuevo registro HR
 */

public class Post_HeartRate extends AsyncTask<Integer, ArrayList, Boolean> {
 ...
 private static String _PATIENT_ID;
    ...
    private final String DATE_TIME, PPM;




    public Post_HeartRate(Context context, String date_time, String ppm) throws ExecutionException, InterruptedException {
    ...
    protected Boolean doInBackground(Integer... params) {
        ...
        try {
            ...
            jsonObject.put(JSON_CONSTANTS.HEART_RATES_PPM, PPM);
