...
Query the given URL, returning a Cursor over the result set.*/
        Cursor cursorPeso = dbPeso.query(true, AutodiagnosticoContract.AutodiagnosticoEntry.TABLE_NAME_PESO,
                camposDBPeso,
        ...
        if (cursorPeso != null & cursorPeso.moveToFirst()) {
            ...
            do {
                ...
                textoAuxiliar = fecha_sin_hora + ";" + cursorPeso.getLong(1);
